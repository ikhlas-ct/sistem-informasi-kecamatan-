          ...
          <div class="card border border-light-subtle rounded-3 shadow-sm">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="text-center mb-3">
                ...
                <h2 class="mb-2">Kecamatan Matur</h2>
                <a href="#!">
                    <img src="{{ asset('home/img/setting/logo.png') }}" alt="Logo"  height="80">
                </a>
              </div>
                ...
                <div class="row gy-2 overflow-hidden">
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="nip_nik" id="nip_nik"  value="{{ old('nip_nik ') }}" placeholder="nip_nik"  required>
                      <label for="nip_nik" class="form-label">ID Staf</label>
                      @error('nip_nik')
