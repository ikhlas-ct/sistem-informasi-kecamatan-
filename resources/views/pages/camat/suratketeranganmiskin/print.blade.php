...
<head>
    ...
    <style>
        ...
        .container {
            ...
            min-height: 29.7cm;
            margin: auto;
            padding: 1cm 2cm 2cm 2cm; /* atas 1cm, kanan 2cm, bawah 2cm, kiri 2cm */
        ...
        .data-table td {
            vertical-align: top;
            padding: 2px 0;      /* lebih kecil dari sebelumnya */
            line-height: 1;      /* jarak antar baris jadi 1 */
        }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                Menurut sepengetahuan kami orang tersebut di atas adalah keluarga <strong>Kurang Mampu</strong>, mempunyai penghasilan kurang dari <strong>Rp. {{ number_format($surat->batas_penghasilan, 0, ',', '.') }},-/bulan</strong>, dengan jumlah tanggungan keluarga  <strong>{{ count($tanggungan) }} orang</strong> sebagai berikut:
            </p>
