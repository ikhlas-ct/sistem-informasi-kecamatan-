...
<div class="container">
    <div class="page-inner">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('nagari.surat_keterangan_miskin') }}" method="GET" class="mb-4">
                    <div class="row">
                        <!-- Tanggal -->
                        <div class="col-md-3">
...
@endif
                                        ...
                                        @if ($item->status === 'selesai')
                                            <button type="button" class="btn btn-sm btn-secondary" onclick="printSurat('{{ route('nagari.surat_keterangan_miskin_print', ['id' => $item->id_pelayanan]) }}')">
    ...
    <div class="modal fade" id="verifikasiModal{{ $item->id_pelayanan }}" tabindex="-1" aria-labelledby="verifikasiModalLabel{{ $item->id_pelayanan }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('walinagari.surat_keterangan_miskin_verifikasi', ['id' => $item->id_pelayanan]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                @if($item->surat_pengantar_rt_rw)
                                    ...
                                    <div class="form-check form-check-inline ms-2">
                                        <input class="form-check-input" type="radio" name="validasi_pengantar" id="pengantar_valid{{ $item->id_pelayanan }}" value="valid_nagari" required>
                            ...
                            <div class="mb-2">
                                ...
                                @if($item->surat_pernyataan_pribadi)
                                    ...
                                    <div class="form-check form-check-inline ms-2">
                                        <input class="form-check-input" type="radio" name="validasi_pernyataan" id="pernyataan_valid{{ $item->id_pelayanan }}" value="valid_nagari" required>
