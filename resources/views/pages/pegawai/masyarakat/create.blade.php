...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Tambah Masyarakat</h5>
            ...
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama_masyarakat"
                                       ...
                                       value="{{ old('nama_masyarakat') }}" placeholder="Masukkan nama lengkap…">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kk"
                                       ...
                                       value="{{ old('kk') }}" placeholder="16 digit No. KK" maxlength="16">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="no_hp"
                                       ...
                                       value="{{ old('no_hp') }}" placeholder="08xxxxxxxxxx" maxlength="20">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="pekerjaan"
                                       ...
                                       value="{{ old('pekerjaan') }}" placeholder="Contoh: Petani, Wiraswasta…">
                ...
                <div class="d-flex gap-2 flex-column">
                    <button type="submit" class="btn btn-submit w-100">
                        <i class="fas fa-save me-2"></i> Simpan Masyarakat
                    </button>
                ...
                <div class="card section-card">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <div class="info-notice mb-2">
                                <i class="fas fa-info-circle"></i>
                                Pilih nagari tempat tinggal masyarakat.
                            </div>
