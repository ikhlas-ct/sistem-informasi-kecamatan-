                ...
                <form action="{{ route('pegawai.surat_keterangan_miskin') }}" method="GET" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-3 align-self-end">
                            ...
                            <!-- Tombol Print -->
                            <button type="button" class="btn btn-secondary" onclick="printSurat('{{ route('camat.surat_keterangan_miskin_laporan', ['hari' => request('hari'), 'bulan' => request('bulan'), 'tahun' => request('tahun')]) }}')">Print</button>
                        </div>
                    </div>
                </form>
                                ...
                                <div class="modal fade" id="verifikasiModal{{ $item->id_pelayanan }}" tabindex="-1" aria-labelledby="verifikasiModalLabel{{ $item->id_pelayanan }}" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('pegawai.surat_keterangan_miskin_terima', ['id' => $item->id_pelayanan]) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            @if($item->surat_pengantar_rt_rw)
                                                                ...
                                                                <div class="form-check form-check-inline ms-2">
                                                                    <input class="form-check-input" type="radio" name="validasi_pengantar" id="pengantar_valid{{ $item->id_pelayanan }}" value="valid" required>
                                                                    <label class="form-check-label" for="pengantar_valid{{ $item->id_pelayanan }}">Valid</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="validasi_pengantar" id="pengantar_tidak_valid{{ $item->id_pelayanan }}" value="tidak_valid">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            @if($item->surat_pernyataan_pribadi)
                                                                ...
                                                                <div class="form-check form-check-inline ms-2">
                                                                    <input class="form-check-input" type="radio" name="validasi_pernyataan" id="pernyataan_valid{{ $item->id_pelayanan }}" value="valid" required>
                                                                    <label class="form-check-label" for="pernyataan_valid{{ $item->id_pelayanan }}">Valid</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="validasi_pernyataan" id="pernyataan_tidak_valid{{ $item->id_pelayanan }}" value="tidak_valid">
