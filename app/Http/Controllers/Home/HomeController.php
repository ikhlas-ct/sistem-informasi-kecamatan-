...
class HomeController extends Controller
{
    public function beranda()
    {
        ...
        $mading = Mading::where('status', 'publish')
            ->where('approval_status', 'approved')
            ->with(['sekolah', 'user.masyarakat'])
            ->withCount('komentar')
        ...
        return view('pages.home.beranda', compact('heros', 'berita', 'mading', 'galeri', 'jenis_konten', 'totalVisitors', 'todayVisitors'));
    }
